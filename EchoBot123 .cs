...
{
    public class EchoBot123 : ActivityHandler
    {
        ...
        protected override async Task OnMessageActivityAsync(ITurnContext<IMessageActivity> turnContext, CancellationToken cancellationToken)
        {
            ...
            //   SecureString password = new NetworkCredential("", "<TN>79MASYCODA").SecurePassword;
            //string password1 = "<TN>79MASYCODA";
            //SecureString secure = password1.ToSecureString();
            password.AppendChar('<');
            ...
            //        {
            //            new QueryOption("startDateTime", "2020-02-20T16:00:00.0000000"),
            //            new QueryOption("endDateTime", "2020-02-26T16:00:00.0000000")
            //        };
            ...
            //        var events = graphClient.Me.Calendar.Events
            //.Request()
            //.GetAsync();
            //        String df = "dsfv";
    ...
    .GetAsync()).ToList();
        ...
        //    String loc = eventss[0].Location.DisplayName;

        //    List<OutlookList> resultview = new List<OutlookList>();
        //    List<Attendeelist> rowwiseattendee = new List<Attendeelist>();
        //    Attendeelist o = new Attendeelist();
        //    for (int i = 0; i < eventss.Count; i++)
        //    {

        //        int countlist = eventss[i].Attendees.Count();
        //        var att = eventss[i].Attendees;
        //        att = att.AsEnumerable().AsQueryable();
                

        //        foreach (var item in att)
        //        {
        //            o.Attendee1 = item.EmailAddress.Name;
        //            rowwiseattendee.Add(o);
        ...
        //        resultview.Add(new OutlookList()
        //        {
        //            location = eventss[i].Location.DisplayName,
        //            End = eventss[i].End.DateTime  ,
        //            Start = eventss[i].Start.DateTime,
        //           Attendees =rowwiseattendee,
        //            Organizer = eventss[i].Organizer.EmailAddress.Address,
        //            BodyPreview = eventss[i].BodyPreview,
        //          //  Body = eventss[i].Body,
        //            Subject = eventss[i].Subject               
        ...
        //    List<OutlookList> copy = new List<OutlookList>(resultview);
          //  List<int> copy = resultview.ToList();
            ...
            //.WithClientSecret("FC3G-nVl-6H?Mn-g72c@.hlbyUtxwHFm")
            //.Build();
            ...
            //var app = PublicClientApplicationBuilder.Create("ef1206af-7a3c-401d-af15-d274d29ea88a").WithRedirectUri().Build();
            ...
            //var clientId = "958dd2d8-b34c-41e5-997f-ae03687736c5";
            //var clientSecret = "pKdmMQx=a2l.UN7rJ4:T2LJHw:LGIB/l";
            //var redirectUri = "http://localhost";
            //var authority = "https://login.microsoftonline.com/fbcab41b-0c15-41f2-9858-b64924a83a6c/v2.0";
            ...
            switch (ans1)
            {
                ...
                default:
                   ...
                   // if (SpListName[0] == staticListName)
                  //  {
        ...
        private static async Task<UAT_LUIS_Entity> GetEntityFromLUIS(string Query)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                string LuisAppID = "ab167f38-5367-421f-8e2c-cfa91d36ca19";// "11838aa9-ca07-4c63-9206-7e422f3a50bd";//"3d87a0d1-a41c-4c2c-b48b-a9bd8c308e61";//"5e376704-da8b-406e-9c68-a7ec15ea29eb";//"6473c60c-64d4-4b4e-895c-946deb9f27bd";//"0e4f70af-c3af-414b-a28f-e9861b17d3ab";//"6473c60c-64d4-4b4e-895c-946deb9f27bd";//"6f963293-9c7a-4393-87eb-9d9a50459662";//ConfigurationManager.AppSettings["aad:LuisAppId"];//["aad:LuisAppId"];
                string LuisSecretKey = "e7301392690a40e387f2a300899d9a4d";//"05b8b88ba1b7480388969d921f5d908c";//"e7301392690a40e387f2a300899d9a4d";//"9f0672f0109247928a0144ca4a910219";//"619b66fbeed048e586e81793f5a69925";//ConfigurationManager.AppSettings["aad:LuisSecretKey"];
        ...
        private static async Task<List<Leave>> GetDynamicQueryForSP(UAT_LUIS_Entity UAT_LUIS)//(string QueryIntent, string QueryEntity)
        {
            ...
            //            else
            //            {
            //                leaveStartDate = new DateTime(DateTime.UtcNow.AddYears(0).Year, 1, 1).ToString("yyyy-MM-ddTHH:mm:ssZ");
            //                leaveEndDate = new DateTime(DateTime.UtcNow.AddYears(0).Year, 12, 31).ToString("yyyy-MM-ddTHH:mm:ssZ");
            //                labelToMakeQuery = "dateRange";
            //            }
            //            break;
            //        }
